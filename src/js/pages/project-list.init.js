        ...
        columns: [
            ...
            },
            {
                ...
                <ul class="dropdown-menu dropdown-menu-end">\
                    <li><a href="/projects/createview" class="dropdown-item edit-list" data-edit-id="'+ full.id + '"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>\
...
if(document.getElementById("addProject-btn")){
