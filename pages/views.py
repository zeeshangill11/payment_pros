...
class home(View):
    def get(self , request):
        greeting = {}
        greeting['heading'] = "Home Page"
        greeting['pageview'] = "Home"
        return render (request,'home/home.html',greeting)

class service(View):
    def get(self , request):
        greeting = {}
        greeting['heading'] = "Service"
        greeting['pageview'] = "Service"
        return render (request,'service/service.html',greeting)

class contact_us(View):
    def get(self , request):
        greeting = {}
        greeting['heading'] = "contact us"
        greeting['pageview'] = "contact_us"
        return render (request,'contact_us/contact_us.html',greeting)
